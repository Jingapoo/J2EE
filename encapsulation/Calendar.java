...
public class Calendar {
    ...
    public void numberToMonth(int num) {
    ...
    public int countDaysInAllMonths(int currentMonth, int currentYear){
    ...
    public int countDaysInAllYears(int currentYear){
    ...
    public void printCalendar(int currentYear) {
